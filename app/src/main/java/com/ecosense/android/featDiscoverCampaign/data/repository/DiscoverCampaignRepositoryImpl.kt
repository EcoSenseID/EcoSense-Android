...
//    override fun getCampaignsByQuery(q: String): Flow<Resource<List<Campaign>>> = flow {
//        emit(Resource.Loading())
//
//        try {
//            val idToken = authApi.getIdToken(true)
//            val bearerToken = "Bearer $idToken"
//            val response = discoverApi.getCampaignsByQuery(bearerToken = bearerToken, q = q)
//
//            when {
//                response.error == true -> emit(Resource.Error(
//                    uiText = response.message?.let { UIText.DynamicString(it) }
...
//    }
//
//    override fun getCampaignsByCategory(categoryId: Int): Flow<Resource<List<Campaign>>> = flow {
//        emit(Resource.Loading())
//
//        try {
//            val idToken = authApi.getIdToken(true)
//            val bearerToken = "Bearer $idToken"
//            val response = discoverApi.getCampaignsByCategory(bearerToken = bearerToken, categoryId = categoryId)
//
//            when {
//                response.error == true -> emit(Resource.Error(
//                    uiText = response.message?.let { UIText.DynamicString(it) }
